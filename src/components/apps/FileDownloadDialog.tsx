        ...
        <div className="flex flex-col gap-4 mb-4 px-2">
          ...
          <div className="flex items-center gap-2 mt-1">
            <input
              ...
              checked
              disabled
              className="w-3 h-3 border border-[#003C74] accent-[#003C74] cursor-not-allowed"
            />
            <label className="text-black cursor-default">Close this dialog box when download completes</label>
          </div>
        </div>
